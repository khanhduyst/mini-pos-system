    ...
    <div class="card-body p-0">
                    ...
                    <?php if (!empty($view_products)): ?>
                        <?php foreach ($view_products as $prod): ?>
                            <tr style="border-bottom: 1px solid #f1f5f9;">
                                ...
                                <td>
                                    <div class="fw-bold text-dark" style="font-size: 15px;"><?php echo $prod['product_name']; ?></div>
                                    ...
                                    <?php else: ?>
                                        <small class="text-muted d-block mt-1" style="font-size: 11px;"><em>Chưa có mô tả ghi chú</em></small>
                                    <?php endif; ?>
                                </td>
        ...
        <?php if ($page_total > 1): ?>
            <div class="card-footer bg-white border-top p-4 d-flex justify-content-between align-items-center">
                <div class="text-secondary small">Hiển thị trang <strong><?php echo $page_current; ?></strong> / <strong><?php echo $page_total; ?></strong> trang</div>
                <nav>
                    <ul class="pagination pagination-sm mb-0 gap-1">
                        ...
                        <li class="page-item <?php echo ($page_current <= 1) ? 'disabled' : ''; ?>">
                            <a class="page-link border rounded-2 px-3 py-2 text-dark shadow-none" href="<?php echo $base_url . ($page_current - 1); ?>">
                                <i class="bi bi-chevron-left"></i>
                            </a>
                        </li>
                        <?php for ($i = 1; $i <= $page_total; $i++): ?>
                            <li class="page-item <?php echo ($page_current == $i) ? 'active' : ''; ?>">
                                <a class="page-link border rounded-2 px-3 py-2 shadow-none fw-semibold <?php echo ($page_current == $i) ? 'text-white bg-primary border-primary' : 'text-dark bg-white'; ?>" href="<?php echo $base_url . $i; ?>">
                                    <?php echo $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content border-0 shadow-lg rounded-4" style="overflow: hidden;">
                    <div class="modal-header p-4 border-bottom-0 bg-white d-flex align-items-start justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h5 class="modal-title fw-bold text-dark" style="font-size: 20px; letter-spacing: -0.3px;"><?php echo $prod['product_name']; ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 border-0 text-start" style="background-color: #f0fdf4;">
                                    ...
                                    <h3 class="fw-bold m-0 font-monospace" style="color: #166534; font-size: 22px;"><?php echo number_format($prod['total_stock']); ?> <span class="small fw-normal" style="font-size: 13px;">cái</span></h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 border-0 text-start" style="background-color: #fefff0;">
                                    ...
                                    <h3 class="fw-bold m-0 font-monospace" style="color: #854d0e; font-size: 22px;"><?php echo number_format($prod['min_price'], 0, '.', ','); ?>đ</h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 border-0 text-start" style="background-color: #fef2f2;">
                                    ...
                                    <h3 class="fw-bold m-0 font-monospace" style="color: #991b1b; font-size: 22px;"><?php echo number_format($prod['max_price'], 0, '.', ','); ?>đ</h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($prod['variants'] as $v): ?>
                                        <tr style="border-bottom: 1px solid #f1f5f9;">
                                            ...
                                            <td class="text-center pe-4">
                                                ...
                                                <?php else: ?>
                                                    <span class="font-monospace fw-bold text-success bg-light px-2 py-1 rounded border" style="font-size: 13px encampment;"><?php echo $v['stock_qty']; ?></span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                    ...
                    <div class="modal-footer p-3 bg-light border-top-0 d-flex justify-content-end gap-2">
                        ...
                        <button type="button" class="btn btn-primary fw-semibold rounded-2 px-4 shadow-none small" style="background-color: #3c50e0; border-color: #3c50e0; font-size: 14px;" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#editProductModal<?php echo $prod['id']; ?>"><i class="bi bi-pencil me-1"></i> Sửa nhanh</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content border-0 shadow rounded-3">
                    ...
                    <form action="/product/edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body p-4 bg-white">
                            ...
                            <?php if (isset($_SESSION['error_edit_prod_id']) && $_SESSION['error_edit_prod_id'] == $prod['id']): ?>
                                <div class="alert alert-danger py-2 px-3 small fw-semibold border-0 rounded-2 mb-3 d-flex align-items-center gap-2" style="background-color: #fde8e8; color: #9b1c1c;">
                                    <i class="bi bi-exclamation-triangle-fill"></i>
                                    <span><?php echo $_SESSION['error_edit_prod_msg']; ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex flex-column align-items-center gap-2 border p-2 rounded-2 bg-light">
                                        ...
                                        <input type="file" class="form-control form-control-sm d-none" id="edit_file_input<?php echo $prod['id']; ?>" name="product_image" accept="image/*" onchange="previewEditImage(this, <?php echo $prod['id']; ?>)">
                                ...
                                <div class="col-md-9">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-6"><label class="form-label small fw-semibold text-secondary">Tên mặt hàng / Sản phẩm (Chung)</label><input type="text" class="form-control form-control-sm" name="product_name" value="<?php echo $prod['product_name']; ?>" required></div>
                                        <div class="col-12">
                            ...
                            <div class="variant-container mb-3" id="editVariantArea<?php echo $prod['id']; ?>">
                                <?php foreach ($prod['variants'] as $v): ?>
                                    <div class="row g-2 align-items-end mb-2 variant-row text-center">
                                        <div class="col-md-2"><input type="text" class="form-control form-control-sm" name="v_name[]" value="<?php echo $v['variant_name']; ?>" required></div>
                                        <div class="col-md-3"><input type="text" class="form-control form-control-sm" name="v_barcode[]" value="<?php echo $v['barcode']; ?>"></div>
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control form-control-sm" name="short_description" rows="2" placeholder="Ví dụ: Kệ A1, hàng dễ vỡ, bảo quản nhiệt độ thường..."><?php echo $prod['short_description']; ?></textarea>
                            </div>
                        </div>
                        <div class="modal-footer border-top p-3 bg-white">
                            ...
                            <button type="submit" class="btn btn-primary fw-semibold rounded-2 px-4" style="background-color: #3c50e0; border-color: #3c50e0;">Lưu cập nhật</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content border-0 shadow rounded-3">
                    <div class="modal-body p-4 text-center">
                        ...
                        <div class="d-flex gap-2 justify-content-center">
                            ...
                            <a href="/product/toggle?id=<?php echo $prod['id']; ?>&status=<?php echo $prod['status']; ?>" class="btn px-4 fw-semibold rounded-2 text-white <?php echo $prod['status'] == 1 ? 'btn-warning bg-warning' : 'btn-success bg-success'; ?>">Xác nhận</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content border-0 shadow rounded-3">
                    <div class="modal-body p-4 text-center">
                        ...
                        <p class="text-muted small mb-4">Hành động này sẽ xóa sạch thông tin mặt hàng <strong class="text-dark"><?php echo $prod['product_name']; ?></strong> và các đơn vị tính con.</p>
                        <div class="d-flex gap-2 justify-content-center">
                            <button type="button" class="btn btn-light px-3 fw-semibold rounded-2 small" data-bs-dismiss="modal">Hủy</button>
                            <a href="/product/delete?id=<?php echo $prod['id']; ?>" class="btn btn-danger bg-danger px-4 fw-semibold rounded-2 text-white">Xác nhận Xóa</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="/product/add" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-4 bg-white">
                    ...
                    <?php if ($is_add_error): ?>
                        <div class="alert alert-danger py-2 px-3 small fw-semibold border-0 rounded-2 mb-3 d-flex align-items-center gap-2" style="background-color: #fde8e8; color: #9b1c1c;">
                            <i class="bi bi-exclamation-triangle-fill"></i>
                            <span><?php echo $_SESSION['error_add_prod']; ?></span>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="row g-2">
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" id="add_product_code" name="product_code" placeholder="SP001" value="<?php echo isset($old_add['product_code']) ? htmlspecialchars($old_add['product_code']) : ''; ?>" required>
                                        <button class="btn btn-outline-secondary" type="button" id="btnRandomProdCode"><i class="bi bi-shuffle"></i></button>
                                    </div>
                                </div>
                                <div class="col-md-7"><label class="form-label small fw-semibold text-secondary">Tên hàng hóa (Chung)</label><input type="text" class="form-control form-control-sm" name="product_name" placeholder="Ví dụ: Kem đánh răng Colgate" value="<?php echo isset($old_add['product_name']) ? htmlspecialchars($old_add['product_name']) : ''; ?>" required></div>
                                <div class="col-12">
                                    <label class="form-label small fw-semibold text-secondary">Danh mục nhóm</label>
                                    <select class="form-select form-select-sm" name="category_id" required>
                                        <option value="">-- Chọn danh mục --</option>
                                        <?php foreach ($view_categories as $cat): ?>
                                            <option value="<?php echo $cat['id']; ?>" <?php echo (isset($old_add['category_id']) && $old_add['category_id'] == $cat['id']) ? 'selected' : ''; ?>><?php echo $cat['category_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="addVariantArea" class="mb-3">
                        <?php if (!empty($old_add['v_name'])): ?>
                            <?php for ($i = 0; $i < count($old_add['v_name']); $i++): ?>
                                <div class="row g-2 align-items-end mb-2 variant-row text-center">
                                    <div class="col-md-2"><input type="text" class="form-control form-control-sm" name="v_name[]" value="<?php echo htmlspecialchars($old_add['v_name'][$i]); ?>" required></div>
                                    <div class="col-md-3"><input type="text" class="form-control form-control-sm" name="v_barcode[]" value="<?php echo htmlspecialchars($old_add['v_barcode'][$i]); ?>"></div>
                                    <div class="col-md-2"><input type="number" class="form-control form-control-sm text-end" name="v_cost[]" value="<?php echo (int)$old_add['v_cost'][$i]; ?>" min="0" required></div>
                                    <div class="col-md-2"><input type="number" class="form-control form-control-sm text-end" name="v_sale[]" value="<?php echo (int)$old_add['v_sale'][$i]; ?>" min="0" required></div>
                                    <div class="col-md-1"><input type="number" class="form-control form-control-sm text-center" name="v_limit[]" value="<?php echo isset($old_add['v_limit'][$i]) ? (int)$old_add['v_limit'][$i] : 10; ?>" min="0" required></div>
                                    <div class="col-md-1"><input type="number" class="form-control form-control-sm text-center" name="v_stock[]" value="<?php echo (int)$old_add['v_stock'][$i]; ?>" min="0" required></div>
                                    <div class="col-md-1"><button type="button" class="btn btn-sm btn-outline-danger w-100 btn-remove-row" style="padding: 4px;" <?php echo ($i === 0) ? 'disabled' : ''; ?>><i class="bi bi-trash"></i></button></div>
                                </div>
                            <?php endfor; ?>
                        <?php else: ?>
                            <div class="row g-2 align-items-end mb-2 variant-row text-center">
                    ...
                    <div class="mb-0">
                        <label class="form-label small fw-semibold text-secondary">Mô tả ngắn đặc điểm / Vị trí kệ kho</label>
                        <textarea class="form-control form-control-sm" name="short_description" rows="2" placeholder="Ví dụ: Kệ A1, hàng tiêu dùng nhanh, bảo quản nhiệt độ thường..."><?php echo isset($old_add['short_description']) ? htmlspecialchars($old_add['short_description']) : ''; ?></textarea>
                    </div>
                </div>
                <div class="modal-footer border-top p-3 bg-white">
                    <button type="button" class="btn btn-light fw-semibold rounded-2 px-3" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-primary fw-semibold rounded-2 px-4" style="background-color: #3c50e0; border-color: #3c50e0;">Lưu thông tin</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <?php if (isset($_SESSION['error_add_prod'])): ?>
            var addModal = new bootstrap.Modal(document.getElementById('addProductModal'));
            addModal.show();
            <?php unset($_SESSION['error_add_prod']);
            unset($_SESSION['old_add_prod_data']); ?>
        <?php endif; ?>

        <?php if (isset($_SESSION['error_edit_prod_id'])): ?>
            var editModalId = 'editProductModal' + '<?php echo $_SESSION['error_edit_prod_id']; ?>';
            var editModal = new bootstrap.Modal(document.getElementById(editModalId));
            editModal.show();
            <?php unset($_SESSION['error_edit_prod_id']);
            unset($_SESSION['error_edit_prod_msg']); ?>
        <?php endif; ?>
    });
</script>
