...
<body>
    ...
    $is_category_active  = (isset($controller_name) && $controller_name === 'category');
    $is_product_active   = (isset($controller_name) && $controller_name === 'product');
    $is_inventory_active = (isset($controller_name) && $controller_name === 'inventory' && isset($action_name) && $action_name === 'index');
    $is_logs_active      = (isset($controller_name) && $controller_name === 'inventory' && isset($action_name) && $action_name === 'logs');

    $is_product_group    = ($is_category_active || $is_product_active || $is_inventory_active || $is_logs_active);
    ?>
    ...
    <div class="sidebar d-flex flex-column p-3">
        ...
        <ul class="nav nav-pills flex-column gap-1 flex-grow-1">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center justify-content-between px-3 py-2 rounded-2 <?php echo ($is_product_group && !$is_category_active && !$is_product_active && !$is_inventory_active && !$is_logs_active) ? 'active' : ''; ?>"
                    ...
                    <i class="bi bi-chevron-down submenu-arrow"
                        style="font-size: 12px; transition: transform 0.2s; color: #475569; transform: <?php echo $is_product_group ? 'rotate(180deg)' : 'rotate(0deg)'; ?>;"></i>
                </a>
                    ...
                    <ul class="list-unstyled m-0 mt-1 d-flex flex-column gap-1" style="padding-left: 12px;">
                        ...
                        <li>
                            <a href="/inventory/index"
                                class="nav-link d-flex align-items-center gap-3 py-2 px-3 rounded-2 <?php echo $is_inventory_active ? 'active' : ''; ?>">
                                <i class="bi bi-clipboard-check" style="font-size: 16px; opacity: 0.8;"></i>
                                <span>Kiểm kê kho quầy</span>
                            </a>
                        </li>
                        <li>
                            <a href="/inventory/logs"
                                class="nav-link d-flex align-items-center gap-3 py-2 px-3 rounded-2 <?php echo $is_logs_active ? 'active' : ''; ?>">
                                <i class="bi bi-journal-text" style="font-size: 16px; opacity: 0.8;"></i>
